...
#define CUSTOM_MACHINE_NAME "La Printoneta"
...
// This will remove the need to poll the interrupt pins, s many CPU cycles.
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -52, -11, 0 } // Baffer: aprox
